...
import CheckoutContent from './contents/CheckoutContent';
...
const CheckoutScreen = () => {
    ...
    //                     <Field
    //                         title='Hora'
    //                         value={format.time(checkoutData.schedule.dateTime, 'HHhMM')}
    //                     />
    ...
    //                     {format.money(checkoutData.summary.totalPrice)}
    //                 </Typo.P1>
    //             </View>
